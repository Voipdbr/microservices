...
public class division {
	...
	public Double divisions(@PathVariable("numberOne") String numberOne , @PathVariable("numberTwo") String numberTwo) throws Exception {
		if(!NumberTreatment.isNumeric(numberOne) || !NumberTreatment.isNumeric(numberTwo)){
			throw new UnsuportedMathOperationException("Please set a numeric value!");
		}
		
		Double division = (NumberTreatment.convertToDouble(numberOne) / NumberTreatment.convertToDouble(numberTwo));
		return division;
	}
